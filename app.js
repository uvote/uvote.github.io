(() => {
  ...
  // node_modules/trunx/dist/classNames.js
  var classNames = (...args) => args.map((arg) => {
    if (Array.isArray(arg)) {
      return arg.length ? classNames(...arg) : "";
    } else if (arg && typeof arg === "object") {
      return classNames(Object.entries(arg).filter(([_, value]) => value).map(([key]) => key));
    }
  ...
  // node_modules/trunx/dist/modifiers/boolean.js
  var camelCaseToKebabCase = (arg) => arg.replace(/([a-z0-9]|(?=[A-Z]))([A-Z0-9])/g, "$1-$2").toLowerCase();
  var modifier = (arg) => Object.entries(arg).map(([key, value]) => value ? camelCaseToKebabCase(key) : "");

  // node_modules/trunx/dist/modifiers/color.js
  var colorClassName = (color) => color ? `is-${color}` : void 0;
  ...
  var Navbar = ({ children, className, color, isTransparent, hasShadow, ...props }) => {
    const _class = classNames("navbar", colorClassName(color), modifier({ hasShadow, isTransparent }), className);
    return (0, import_jsx_runtime28.jsx)("nav", { className: _class, ...props, children });
  };
  var NavbarBrand = ({ children, className, ...props }) => {
    const _class = classNames("navbar-brand", className);
    return (0, import_jsx_runtime28.jsx)("div", { className: _class, ...props, children });
  };
  var NavbarBurger = ({ className, isActive, content = (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [(0, import_jsx_runtime28.jsx)("span", { "aria-hidden": "true" }), (0, import_jsx_runtime28.jsx)("span", { "aria-hidden": "true" }), (0, import_jsx_runtime28.jsx)("span", { "aria-hidden": "true" })] }), ...props }) => {
    const _class = classNames("navbar-burger", className);
    return (0, import_jsx_runtime28.jsx)("div", { "aria-expanded": isActive ? "true" : "false", "aria-label": "menu", role: "button", className: _class, ...props, children: content });
  };
  var NavbarEnd = ({ children, className, ...props }) => {
    const _class = classNames("navbar-end", className);
    return (0, import_jsx_runtime28.jsx)("div", { className: _class, ...props, children });
  };
  var NavbarItem = ({ children, className, hasDropdown, hasDropdownUp, isActive, isExpanded, isHoverable, isTab, ...props }) => {
    const _class = classNames("navbar-item", modifier({ hasDropdown, hasDropdownUp, isActive, isExpanded, isHoverable, isTab }), className);
    return (0, import_jsx_runtime28.jsx)("div", { className: _class, ...props, children });
  };
  var NavbarItemAnchor = ({ children, className, isActive, ...props }) => {
    const _class = classNames("navbar-item", modifier({ isActive }), className);
    return (0, import_jsx_runtime28.jsx)("a", { className: _class, ...props, children });
  };
  var NavbarMenu = ({ children, className, isActive }) => {
    const _class = classNames("navbar-menu", modifier({ isActive }), className);
    return (0, import_jsx_runtime28.jsx)("div", { className: _class, children });
  };
  ...
  function Navigation() {
    ...
    const onClickBurger = (0, import_react.useCallback)((event) => {
      event.stopPropagation();
      setIsActive((isActive2) => !isActive2);
    }, []);
    ...
    return /* @__PURE__ */ React.createElement(Navbar, { color: "light" }, /* @__PURE__ */ React.createElement(NavbarBrand, null, /* @__PURE__ */ React.createElement(NavbarItem, null, /* @__PURE__ */ React.createElement("img", { src: "logo-type.png", alt: "" })), /* @__PURE__ */ React.createElement(NavbarBurger, { isActive, onClick: onClickBurger })), /* @__PURE__ */ React.createElement(NavbarMenu, { isActive }, /* @__PURE__ */ React.createElement(NavbarEnd, null, /* @__PURE__ */ React.createElement(NavbarItemAnchor, { href: "https://github.com/uvote" }, "GitHub"))));
  }
  ...
  function App() {
    return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(Navigation, null));
  }
})();
